...
def main():
    ...
    parser.add_argument('--lr-layer-norm', type=float, nargs='+', default=(0.05,0.05,0.1))
    ...
    parser.add_argument('--threshold', type=float, default=0.4)#1.5
    ...
    parser.add_argument('--w-init-gain', type=float, nargs='+', default=(0.5,0.5,0.5)) 
