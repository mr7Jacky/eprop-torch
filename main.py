...
def main():
    ...
    parser.add_argument('--w-init-gain', type=float, nargs='+', default=(0.5,0.1,0.1,0.1,0.5), help='Gain parameter for the He Normal initialization of the input, recurrent and output layer weights')
